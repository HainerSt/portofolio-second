...
const Hero = () => {
  return (
    <div className="pt-36 pb-20 h-[90vh] ">
      <div>
      ...
      <div>
        <div className="h-[90vh] w-full dark:bg-black-100 bg-white  dark:bg-grid-white/[0.05] bg-grid-black/[0.2]flex items-center justify-center absolute top-p left-0">
