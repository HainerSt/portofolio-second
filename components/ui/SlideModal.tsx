      ...
      <div className="flex flex-row gap-12 lg:gap-8 ">
        {profilelinks.map((profile) => (
          <a
            ...
            className="relative bg-black dark:bg-white dark:text-black text-white flex items-center justify-center group hover:no-underline w-20 h-20 lg:w-24 lg:h-24 overflow-hidden sm:rounded-xl lg:rounded-full shadow-md"
          >
            {/* Title */}
